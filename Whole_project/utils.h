/**
 * @file utils.h
 * @details This file exports handy toolkits shared in the project.
 */
...
/**
 * @brief Convert defined instruction in place.
 */

void convertInstruction(std::string& instruction, std::string var_name,
