 ...
 * @details This file exports <code>Simulator</code> class simulating processing MIPS
...
/**
 * @brief Write single-byte data to the given address.
...
/**
 * @brief Write two-consecutive-byte data to the given address.
 * @warning Abort if <code>address</code> is out of bound.
 */
...
/**
 * @brief Write four-consecutive-byte data to the given address.
 * @warning Abort if <code>address</code> is out of bound.
 */
...
/**
 * @brief Read single-byte data to the given address.
 * @warning Abort if <code>address</code> is out of bound.
...
/**
 * @brief Read two-consecutive-byte data to the given address.
 * @warning Abort if <code>address</code> is out of bound.
 * @warning Unsigned extension if return value is int type.
 */
...
/**
 * @brief Read four-consecutive-byte data to the given address.
 * @warning Abort if <code>address</code> is out of bound.
 * @warning Unsigned extension if return value is int type.
 */
...
/**
 * @brief Calculate corresponding simulated block index given <code>address</code>.
 * @warning Abort if <code>address</code> is out of bound.
 */
...
/**
 * @brief Initializers for <code>Simulator</code> class.
 */
