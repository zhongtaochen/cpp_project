...
enum OperandType {NONE, RD, RS, RT, SA, IMM, IMM_RS, LABEL, RDEST, RSRC1, RSRC2, SRC2, ADDRESS, FRSRC1, FDEST};
struct Format {OperandType op1; OperandType op2; OperandType op3; int id;};
struct Format_Pseudo {OperandType op1; OperandType op2; OperandType op3;};
